...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Get user's active device from Firestore
    ...
    if (activeDeviceId && activeDeviceId !== deviceId) {
      // This device has been replaced by another device
      console.log(`Device ${deviceId} revoked for user ${uid}. Active device is now ${activeDeviceId}`);
