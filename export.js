  ...
  try {
    ...
    usersSnapshot.forEach(doc => {
      ...
      users.push({
        ...
        lastActive: data.usage?.lastActive?.toDate?.() || data.usage?.lastActive,
      });
    });
    ...
    if (format === 'csv') {
      // Generate CSV
      const headers = ['UID', 'Email', 'Display Name', 'Role', 'Status', 'Plan', 'Total Requests', 'Created At', 'Last Active'];
